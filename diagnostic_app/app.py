...
async def admin_leads():
    ...
    for row in rows:
        ...
        ">
            ...
            <div style="margin-top:12px;">
                <b>Contact :</b> {html.escape(row["email"] or "-")}
            </div>

            <div style="margin-top:8px;">
                <b>Niveau :</b> {html.escape(row["level"] or "-")}
            </div>

            <div style="margin-top:8px;">
                <b>Temps estimé :</b> {row["estimated_min"] or 0} à {row["estimated_max"] or 0}h / semaine
            </div>

            <div style="margin-top:8px;">
                <b>Tâches indiquées :</b><br>
                <div style="white-space:pre-wrap;background:#f8fafc;border-radius:12px;padding:10px;margin-top:6px;">
                    {html.escape(row["repetitive_tasks"] or "-")}
                </div>
            </div>
        </div>
        """)
    ...
    <body style="font-family:system-ui;background:#f6f4f8;padding:24px;color:#25255A;">
